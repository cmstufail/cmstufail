...
## **📊 GitHub Stats**
<p align="center">
  <img src="https://github-readme-stats.vercel.app/api?username=cmstufail&show_icons=true&theme=radical" width="30%" height="120px" />
  <img src="https://github-readme-stats.vercel.app/api/top-langs/?username=cmstufail&layout=compact&theme=radical" width="30%" height="118px" />
</p>
...
1.  First, clone this repository:
    ```bash
    git clone [https://github.com/your-username/app-orbit-client.git](https://github.com/your-username/app-orbit-client.git)
    ```
...
3.  Install the required dependencies:
    ...
    npm install
    ```
4.  Create a `.env.local` file and add your Firebase and Stripe public keys here.
...
1.  First, clone this repository:
    ```bash
    git clone [https://github.com/your-username/app-orbit-server.git](https://github.com/your-username/app-orbit-server.git)
    ```
2.  Go to the project folder:
    ```bash
    cd app-orbit-server
...
3.  Install the required dependencies:
    ...
    npm install
    ```
4.  Create a `.env` file and add your database URI, Stripe secret key, and JWT secret here.
5.  Launch the project:
    ```bash
    npm start
    ```
